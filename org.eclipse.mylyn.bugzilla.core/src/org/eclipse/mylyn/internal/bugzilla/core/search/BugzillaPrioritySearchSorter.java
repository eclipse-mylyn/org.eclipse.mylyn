...
public class BugzillaPrioritySearchSorter extends ViewerSorter {
	...
	public int compare(Viewer viewer, Object e1, Object e2) {
		try {
			...
			Integer pr1 = (Integer) entry1.getAttribute(IBugzillaConstants.HIT_MARKER_ATTR_PRIORITY);

			// cast the other object and get the bugs priority
			IMarker entry2 = (IMarker) e2;
			Integer pr2 = (Integer) entry2.getAttribute(IBugzillaConstants.HIT_MARKER_ATTR_PRIORITY);
