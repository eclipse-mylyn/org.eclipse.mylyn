...
public class BugzillaSeveritySearchSorter extends ViewerSorter {
	...
	public int compare(Viewer viewer, Object e1, Object e2) {
		try {
			...
			Integer severity1 = (Integer) entry1.getAttribute(IBugzillaConstants.HIT_MARKER_ATTR_SEVERITY);

			// cast the other object and get its severity
			IMarker entry2 = (IMarker) e2;
			Integer severity2 = (Integer) entry2.getAttribute(IBugzillaConstants.HIT_MARKER_ATTR_SEVERITY);
