 ...
 *    See git history
 *****************************************************************************/
package org.eclipse.mylyn.internal.github.egit.github.core.util;

import static org.eclipse.mylyn.internal.github.egit.github.core.client.IGitHubConstants.CHARSET_ISO_8859_1;
import static org.eclipse.mylyn.internal.github.egit.github.core.client.IGitHubConstants.HOST_DEFAULT;
import static org.eclipse.mylyn.internal.github.egit.github.core.client.IGitHubConstants.SUFFIX_GIT;
...
public final class UrlUtils {
	 ...
	 * @return URL
	 */
	public static String createRemoteSshUrl(GHRepository repository) {
	 ...
	 * @return URL
	 */
	public static String createRemoteSshUrl(GHRepository repository, String host) {
		return "git@" + host + ":" + repository.getId() + SUFFIX_GIT; //$NON-NLS-1$ //$NON-NLS-2$
	}
	 ...
	 * @return URL
	 */
	public static String createRemoteHttpsUrl(GHRepository repository, String user) {
	 ...
	 * @return URL
	 */
	public static String createRemoteHttpsUrl(GHRepository repository, String host, String user) {
		return "https://" + user + "@" + host + "/" + repository.getId() //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		+ SUFFIX_GIT;
	}
	 ...
	 * @return URL
	 */
	public static String createRemoteReadOnlyUrl(GHRepository repository) {
	 ...
	 * @return URL
	 */
	public static String createRemoteReadOnlyUrl(GHRepository repository, String host) {
		return "git://" + host + "/" + repository.getId() + SUFFIX_GIT; //$NON-NLS-1$ //$NON-NLS-2$
	}
