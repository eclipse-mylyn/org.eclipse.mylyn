...
/**
 * Programming languages available in github search at https://github.com/search/advanced.
 */
public final class Languages {
	...
	private static final String[] languages = { "ActionScript", //$NON-NLS-1$
			"C", //$NON-NLS-1$
			"C#", //$NON-NLS-1$
			"C++", //$NON-NLS-1$
			"Clojure", //$NON-NLS-1$
	...
	public static String[] getLanguages() {
		return Arrays.stream(languages).sorted(String.CASE_INSENSITIVE_ORDER).toArray(String[]::new);
	}
}
