 ...
 *    See git history
 *******************************************************************************/
package org.eclipse.mylyn.internal.github.egit.github.core.service;
...
//
//	/**
//	 * Unified paged request creation method that all sub-classes should use so overriding classes can extend and configure the default
//	 * request.
//	 *
//	 * @return request
//	 */
...
//
//	/**
//	 * Unified page iterator creation method that all sub-classes should use so overriding classes can extend and configure the default
//	 * iterator.
//	 *
//	 * @param request
//	 * @return iterator
