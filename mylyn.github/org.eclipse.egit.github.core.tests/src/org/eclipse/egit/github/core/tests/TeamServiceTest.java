...
public class TeamServiceTest {
	...
	public void getTeamsNullName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.getTeams((String) null));
	}
	...
	public void getTeamsEmptyName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.getTeams(""));
	}
	...
	public void createTeamNullOrg() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.createTeam(null, new Team().setName("pullers")));
	}
	...
	public void createTeamEmptyOrg() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.createTeam("", new Team().setName("pullers")));
	}
	...
	public void createTeamNullTeam() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.createTeam("group", null));
	}
	...
	public void editTeamNullTeam() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.editTeam(null));
	}
	...
	public void isMemberNullName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.isMember(2, null));
	}
	...
	public void isMemberEmptyName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.isMember(2, ""));
	}
	...
	public void addMemberNullName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.addMember(2, null));
	}
	...
	public void addMemberEmptyName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.addMember(2, ""));
	}
	...
	public void removeMemberNullName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.removeMember(3, null));
	}
	...
	public void removeMemberEmptyName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.removeMember(3, ""));
	}

	@Test
	public void getMembershipNullName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.getMembership(6, null));
	}

	@Test
	public void getMembershipEmptyName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.getMembership(6, ""));
	}
	...
	public void addMembershipNullName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.addMembership(6, null));
	}

	@Test
	public void addMembershipEmptyName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.addMembership(6, ""));
	}
	...
	public void removeMembershipNullName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.removeMembership(6, null));
	}

	@Test
	public void removeMembershipEmptyName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.removeMembership(6, ""));
	}
