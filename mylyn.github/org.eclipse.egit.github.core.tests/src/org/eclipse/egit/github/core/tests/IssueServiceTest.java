...
public class IssueServiceTest {
	...
	public void constructorNullArgument() {
		assertThrows(IllegalArgumentException.class, () -> new IssueService(null));
	}
	...
	public void getIssueNullUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getIssue(null, "not null", "not null"));
	}
	...
	public void getIssueNullRepositoryId() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getIssue(null, 1));
	}
	...
	public void getIssueEmptyUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getIssue("", "repo", "not null"));
	}
	...
	public void getIssueNullRepositoryName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getIssue("not null", null, "not null"));
	}
	...
	public void getIssueEmptyRepositoryName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getIssue("user", "", "not null"));
	}
	...
	public void getIssueNullId() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getIssue("not null", "not null", null));
	}
	...
	public void getIssueEmptyId() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getIssue("not null", "not null", ""));
	}
	...
	public void getCommentsNullUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getComments(null, "not null", 1));
	}
	...
	public void getCommentsEmptyUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getComments("", "not null", 2));
	}
	...
	public void getCommentsNullRepositoryName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getComments("not null", null, 3));
	}
	...
	public void getCommentsNullRepositoryId() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getComments(null, 3));
	}
	...
	public void getCommentsEmptyRepositoryName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getComments("not null", "", 3));
	}
	...
	public void getCommentsNullId() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getComments("not null", "not null", null));
	}
	...
	public void getCommentsEmptyId() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getComments("not null", "not null", ""));
	}
	...
	public void getIssuesNullUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getIssues(null, "not null", null));
	}
	...
	public void getIssuesNullRepositoryId() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getIssues(null, null));
	}
	...
	public void getIssuesEmptyUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getIssues("", "not null", null));
	}
	...
	public void getIssuesNullRepositoryName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.getIssues("not null", null, null));
	}
	...
	public void createIssueNullUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.createIssue(null, "not null", new Issue()));
	}
	...
	public void createIssueEmptyUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.createIssue("", "not null", new Issue()));
	}
	...
	public void createIssueNullRepositoryName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.createIssue("not null", null, null));
	}
	...
	public void createIssueNullIssue() throws IOException {
		...
		verify(gitHubClient).post("/repos/test_user/test_repository/issues", new HashMap<>(), Issue.class);
	}
	...
	public void createIssueNullIssueWithRepositoryId() throws IOException {
		...
		verify(gitHubClient).post("/repos/tu/tr/issues", new HashMap<>(), Issue.class);
	}
	...
	public void editIssueNullUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.editIssue(null, "not null", new Issue()));
	}
	...
	public void editIssueEmptyUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.editIssue("", "not null", new Issue()));
	}
	...
	public void editIssueNullRepositoryName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.editIssue("not null", null, new Issue()));
	}
	...
	public void editIssueNullIssue() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.editIssue("not null", "not null", null));
	}
	...
	public void createCommentNullUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.createComment(null, "not null", 1, "not null"));
	}
	...
	public void createCommentEmptyUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.createComment("", "not null", 2, "not null"));
	}
	...
	public void createCommentNullRepositoryName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.createComment("not null", null, 3, "not null"));
	}
	...
	public void createCommentEmptyRepositoryName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.createComment("not null", "", 4, "not null"));
	}
	...
	public void createComment() throws IOException {
		...
		verify(gitHubClient).post(
				"/repos/test_user/test_repository/issues/1/comments", params, Comment.class);
	}
	...
	public void deleteCommentNullUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.deleteComment(null, "repo", 1));
	}
	...
	public void deleteCommentEmptyUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.deleteComment("", "repo", 1));
	}
	...
	public void deleteCommentNullRepositoryName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.deleteComment("user", null, 1));
	}
	...
	public void deleteCommentEmptyRepositoryName() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.deleteComment("user", "", 1));
	}
	...
	public void deleteCommentNullId() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.deleteComment("user", "repo", null));
	}
	...
	public void deleteCommentEmptyId() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.deleteComment("user", "repo", ""));
	}
	...
	public void editIssueCommentNullComment() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.editComment("user", "repo", null));
	}
	...
	public void searchIssuesNullRepository() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> issueService.searchIssues(null, "open", "test"));
	}
	...
	public void searchIssueNullQuery() throws IOException {
		RepositoryId id = new RepositoryId("user", "repo");
		assertThrows(IllegalArgumentException.class, () -> issueService.searchIssues(id, "open", null));
	}
	...
	public void searchIssueEmptyQuery() throws IOException {
		RepositoryId id = new RepositoryId("user", "repo");
		assertThrows(IllegalArgumentException.class, () -> issueService.searchIssues(id, "open", ""));
	}
	...
	public void searchIssueNullState() throws IOException {
		RepositoryId id = new RepositoryId("user", "repo");
		assertThrows(IllegalArgumentException.class, () -> issueService.searchIssues(id, null, "test"));
	}
	...
	public void searchIssueEmptyState() throws IOException {
		RepositoryId id = new RepositoryId("user", "repo");
		assertThrows(IllegalArgumentException.class, () -> issueService.searchIssues(id, "", "test"));
	}
