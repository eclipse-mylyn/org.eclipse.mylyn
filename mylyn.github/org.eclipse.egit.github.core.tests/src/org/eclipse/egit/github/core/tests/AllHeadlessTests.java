...
@SuiteClasses({ BlobTest.class, CollaboratorServiceTest.class,
		...
		GitHubClientTest.class, IdTest.class, IssueEventTest.class,
		IssueServiceTest.class, IssueTest.class, KeyTest.class,
		...
		RepositoryCommitTest.class, RepositoryIdTest.class,
