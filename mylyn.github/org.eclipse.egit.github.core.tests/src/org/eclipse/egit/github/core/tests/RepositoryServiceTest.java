...
public class RepositoryServiceTest {
	...
	public void createRepositoryNullRepository() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.createRepository(null));
	}
	...
	public void editRepositoryNullRepository() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.editRepository(null));
	}
	...
	public void editRepositoryWithNullFields() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.editRepository("o", "n", null));
	}
	...
	public void editRepositoryProviderWithNullFields() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.editRepository(repo, null));
	}
	...
	public void createOrgRepositoryNullOrg() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.createRepository(null, new Repository()));
	}
	...
	public void createOrgRepositoryEmptyOrg() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.createRepository("", new Repository()));
	}
	...
	public void createOrgRepositoryNullRepository() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.createRepository("anorg", null));
	}
	...
	public void getRepositoriesNullUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.getRepositories((String) null));
	}
	...
	public void getRepositoriesEmptyUser() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.getRepositories(""));
	}
	...
	public void getRepositoriesNullOrg() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.getOrgRepositories(null));
	}
	...
	public void getRepositoriesEmptyOrg() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.getOrgRepositories(""));
	}
	...
	public void searchRepositoriesNullQuery() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.searchRepositories((String) null));
	}
	...
	public void searchRepositoriesEmptyQuery() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.searchRepositories(""));
	}
	...
	public void editHookNullHook() throws IOException {
		assertThrows(IllegalArgumentException.class, () -> service.editHook(repo, null));
	}
