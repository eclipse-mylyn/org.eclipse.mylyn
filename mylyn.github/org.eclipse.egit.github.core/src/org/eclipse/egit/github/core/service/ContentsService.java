 ...
 *
 * @see <a href="http://developer.github.com/v3/repos/contents">GitHub contents API documentation</a>
 */
public class ContentsService extends GitHubService {
	...
	public List<RepositoryContents> getContents(IRepositoryIdProvider repository, String path, String ref)
			throws IOException {
		String id = getId(repository);
