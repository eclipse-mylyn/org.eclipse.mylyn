...
/**
 * Exception class to be thrown when iterating over pages fails. This exception wraps an {@link IOException} that is the actual exception
 * that occurred when the page request was made.
 */
