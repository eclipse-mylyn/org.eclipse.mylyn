 ...
 *
 * @see <a href="http://developer.github.com/v3/repos/commits">GitHub commit API documentation</a>
 */
public class CommitService extends GitHubService {
	...
	/**
	 * Get diff for commit with given SHA-1 from given repository. It is the responsibility of the calling method to close the returned
	 * stream.
	 *
	 * @param repository
	 * @param sha
	...
	/**
	 * Get patch for commit with given SHA-1 from given repository. It is the responsibility of the calling method to close the returned
	 * stream.
	 *
	 * @param repository
	 * @param sha
	 ...
	 * @throws IOException
	 */
	public CommitComment addComment(IRepositoryIdProvider repository, String sha, CommitComment comment)
			throws IOException {
		String id = getId(repository);
		if (sha == null) {
			throw new IllegalArgumentException("Sha cannot be null"); //$NON-NLS-1$
	 ...
	 * @throws IOException
	 */
	public RepositoryCommitCompare compare(IRepositoryIdProvider repository, String base, String head)
			throws IOException {
	...
	/**
	 * Get diff between base and head commits. It is the responsibility of the calling method to close the returned stream.
	 *
	 * @param repository
	 * @param base
	 * @param head
	...
	/**
	 * Get patch between base and head commits. It is the responsibility of the calling method to close the returned stream.
	 *
	 * @param repository
	 * @param base
	 * @param head
