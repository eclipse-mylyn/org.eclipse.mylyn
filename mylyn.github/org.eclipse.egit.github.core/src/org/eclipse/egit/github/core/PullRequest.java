...
public class PullRequest implements Serializable {
	...
	/**
	 * Tells whether the pull request can be merged. The value may be {@code null}, which indicates that GitHub is busy computing this
	 * information but hasn't determined it yet.
	 *
	 * @return whether the pull request is mergeable, or {@code null} if not known yet and GitHub is busy calculating the mergeability.
	 * @see <a href= "https://developer.github.com/v3/pulls/#get-a-single-pull-request">GitHub Rest API v3: Pull Requests</a>
	 */
