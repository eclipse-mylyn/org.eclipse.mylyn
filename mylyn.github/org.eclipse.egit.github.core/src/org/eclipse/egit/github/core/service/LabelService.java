...
/**
 * Label service class for listing {@link Label} objects in use for a given repository.
 *
 * @see <a href="http://developer.github.com/v3/issues/labels">GitHub labels API documentation</a>
 */
public class LabelService extends GitHubService {
	 ...
	 * @throws IOException
	 */
	public List<Label> setLabels(IRepositoryIdProvider repository, String issueId, List<Label> labels)
			throws IOException {
		String repoId = getId(repository);
	 ...
	 * @throws IOException
	 */
	public List<Label> setLabels(String user, String repository, String issueId, List<Label> labels)
			throws IOException {
		verifyRepository(user, repository);
