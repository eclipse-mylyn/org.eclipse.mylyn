...
/**
 * Milestone service class for listing the {@link Milestone} objects in use by a repository and user accessed via a {@link GitHubClient}.
 *
 * @see <a href="http://developer.github.com/v3/issues/milestones">GitHub milestones API documentation</a>
 */
public class MilestoneService extends GitHubService {
	...
	private Milestone getMilestone(String id, String number) throws IOException {
		...
		String uri = SEGMENT_REPOS + '/' + id + SEGMENT_MILESTONES + '/' + number;
	...
	private void deleteMilestone(String id, String milestone) throws IOException {
		...
		String uri = SEGMENT_REPOS + '/' + id + SEGMENT_MILESTONES + '/' + milestone;
		client.delete(uri);
	}
	...
	public Milestone editMilestone(IRepositoryIdProvider repository, Milestone milestone) throws IOException {
		...
		String uri = SEGMENT_REPOS + '/' + repoId + SEGMENT_MILESTONES + '/' + milestone.getNumber();
