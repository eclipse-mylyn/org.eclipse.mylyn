 ...
 *
 * @see <a href="http://developer.github.com/v3/events">GitHub Event API documentation</a>
 * @see <a href="http://developer.github.com/v3/events/types">GitHub Event types API documentation</a>
 */
public class EventService extends GitHubService {
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageEvents(IRepositoryIdProvider repository, final int size) {
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageEvents(IRepositoryIdProvider repository, final int start, final int size) {
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageNetworkEvents(IRepositoryIdProvider repository, final int size) {
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageNetworkEvents(IRepositoryIdProvider repository, final int start, final int size) {
		PagedRequest<Event> request = createNetworkRepoEventRequest(repository, start, size);
		return createPageIterator(request);
	}
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageOrgEvents(String org, final int start, final int size) {
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageUserReceivedEvents(String user, boolean isPublic, final int size) {
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageUserReceivedEvents(String user, boolean isPublic, final int start, final int size) {
		PagedRequest<Event> request = createUserReceivedEventRequest(user, isPublic, start, size);
		return createPageIterator(request);
	}
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageUserEvents(String user, boolean isPublic, final int size) {
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageUserEvents(String user, boolean isPublic, final int start, final int size) {
		PagedRequest<Event> request = createUserEventRequest(user, isPublic, start, size);
		return createPageIterator(request);
	}
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageUserOrgEvents(String user, String org, final int start, final int size) {
