 ...
 *
 * @see <a href="http://developer.github.com/v3/markdown/">GitHub Markdown API documentation</a>
 */
public class MarkdownService extends GitHubService {
	...
	/**
	 * Get stream of HTML for given Markdown text scoped to given repository context
	 *
	 * @param repo
	 * @param text
	 ...
	 * <p>
	 * Use {@link #getRepositoryStream(IRepositoryIdProvider, String)} if you want the Markdown scoped to a specific repository.
	 *
	 * @param text
	 * @param mode
	 * @return stream of HTML
	 ...
	 * <p>
	 * Use {@link #getRepositoryHtml(IRepositoryIdProvider, String)} if you want the Markdown scoped to a specific repository.
	 *
	 * @param text
	 * @param mode
	 * @return HTML
