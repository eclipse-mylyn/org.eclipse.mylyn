 ...
 *
 * @see <a href="http://developer.github.com/v3/orgs">GitHub organization API documentation</a>
 * @see <a href="http://developer.github.com/v3/orgs/members">GitHub organization membership API documentation</a>
 */
public class OrganizationService extends GitHubService {
	...
	public List<User> getOrganizations() throws IOException {
		PagedRequest<User> request = createOrgRequest(null, PAGE_FIRST, PAGE_SIZE);
	...
	public List<User> getOrganizations(String user) throws IOException {
		...
		PagedRequest<User> request = createOrgRequest(user, PAGE_FIRST, PAGE_SIZE);
		return getAll(request);
	}
	 ...
	 *            application/vnd.github.ironman-preview+json} Accept header in the {@link GitHubClient#setHeaderAccept GitHubClient}
