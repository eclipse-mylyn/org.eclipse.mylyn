...
/**
 * Page link class to be used to determine the links to other pages of request responses encoded in the current response. These will be
 * present if the result set size exceeds the per page limit.
 */
