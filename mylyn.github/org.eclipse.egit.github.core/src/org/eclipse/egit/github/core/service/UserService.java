 ...
 * User service class.
 *
 * @see <a href="http://developer.github.com/v3/users">GitHub users API documentation</a>
 * @see <a href="http://developer.github.com/v3/users/followers">GitHub followers API documentation</a>
 * @see <a href="http://developer.github.com/v3/users/emails">GitHub user email API documentation</a>
 * @see <a href="http://developer.github.com/v3/users/keys">GitHub user keys API documentation</a>
 */
