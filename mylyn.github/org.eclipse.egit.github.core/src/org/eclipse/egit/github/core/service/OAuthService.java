 ...
 *
 * @see <a href="http://developer.github.com/v3/oauth/">GitHub OAuth API documentation</a>
 */
public class OAuthService extends GitHubService {
	...
	public Authorization createAuthorization(Authorization authorization) throws IOException {
		return client.post(SEGMENT_AUTHORIZATIONS, authorization, Authorization.class);
	}
