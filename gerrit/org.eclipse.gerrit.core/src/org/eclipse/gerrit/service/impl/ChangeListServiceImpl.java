 ...
 *********************************************************************/
package org.eclipse.gerrit.service.impl;
...
import org.eclipse.gerrit.service.AbstractGerritService;

public class ChangeListServiceImpl extends AbstractGerritService implements ChangeListService {

  public ChangeListServiceImpl(AbstractGerritHttpClient client) {
    super(client);
  ...
  public void allClosedNext(Status status, String pos, int limit,
  ...
  public void allClosedPrev(Status status, String pos, int limit,
    AsyncCallback<SingleListChangeInfo> callback) {
    String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
    LinkedList<JsonParam> a = new LinkedList<JsonParam>();
    a.add(new JsonParam(pos));
  ...
  public void allQueryNext(String query, String pos, int limit,
    AsyncCallback<SingleListChangeInfo> callback) {
    String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
    LinkedList<JsonParam> a = new LinkedList<JsonParam>();
  ...
  public void allQueryPrev(String query, String pos, int limit,
    AsyncCallback<SingleListChangeInfo> callback) {
    String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
    LinkedList<JsonParam> a = new LinkedList<JsonParam>();
    a.add(new JsonParam(pos));
  ...
  public void byProjectOpenNext(NameKey project, String pos, int limit,
    AsyncCallback<SingleListChangeInfo> callback) {
    String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
    LinkedList<JsonParam> a = new LinkedList<JsonParam>();
    a.add(new JsonParam(project));
  ...
  public void byProjectOpenPrev(NameKey project, String pos, int limit,
    AsyncCallback<SingleListChangeInfo> callback) {
    String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
    LinkedList<JsonParam> a = new LinkedList<JsonParam>();
    a.add(new JsonParam(project));
  ...
  public void myStarredChangeIds(AsyncCallback<Set<com.google.gerrit.reviewdb.Change.Id>> callback) {
    ...
    try {
      ...
      Gson gson = JsonServlet.defaultGsonBuilder().create();
      JsonResult<Set<com.google.gerrit.reviewdb.Change.Id>> result = gson.fromJson(responseMessage,
        resultType);
