...
public class GerritConnector extends AbstractRepositoryConnector {
	...
	/* (non-Javadoc)
	 * 
	 * @see org.eclipse.mylyn.tasks.core.AbstractRepositoryConnector#canCreateNewTask
	...
	/* (non-Javadoc)
	 * 
	 * @see org.eclipse.mylyn.tasks.core.AbstractRepositoryConnector#canCreateTaskFromKey
	 * (org.eclipse.mylyn.tasks.core.TaskRepository) */
	@Override
	...
	/* (non-Javadoc)
	 * 
	 * @seeorg.eclipse.mylyn.tasks.core.AbstractRepositoryConnector# getRepositoryUrlFromTaskUrl(java.lang.String) */
	@Override
	...
	/* (non-Javadoc)
	 * 
	 * @see org.eclipse.mylyn.tasks.core.AbstractRepositoryConnector#getTaskData(
	 * org.eclipse.mylyn.tasks.core.TaskRepository, java.lang.String, org.eclipse.core.runtime.IProgressMonitor) */
	@Override
	...
	/* (non-Javadoc)
	 * 
	 * @see org.eclipse.mylyn.tasks.core.AbstractRepositoryConnector#hasTaskChanged
	 * (org.eclipse.mylyn.tasks.core.TaskRepository, org.eclipse.mylyn.tasks.core.ITask,
	...
	/* (non-Javadoc)
	 * 
	 * @see org.eclipse.mylyn.tasks.core.AbstractRepositoryConnector#performQuery
	 * (org.eclipse.mylyn.tasks.core.TaskRepository, org.eclipse.mylyn.tasks.core.IRepositoryQuery,
	 * org.eclipse.mylyn.tasks.core.data.TaskDataCollector, org.eclipse.mylyn.tasks.core.sync.ISynchronizationSession,
	...
	@Override
	public void updateRepositoryConfiguration(TaskRepository arg0, IProgressMonitor arg1) throws CoreException {
	 ...
	 * updateTaskFromTaskData(org.eclipse.mylyn.tasks.core.TaskRepository, org.eclipse.mylyn.tasks.core.ITask,
	 * org.eclipse.mylyn.tasks.core.data.TaskData) */
	@Override
	...
	/* (non-Javadoc)
	 * 
	 * @see org.eclipse.mylyn.tasks.core.AbstractRepositoryConnector#getTaskMapping
	 * (org.eclipse.mylyn.tasks.core.data.TaskData) */
	@Override
	 ...
	 * 
	 * @param repository
	 *            The task repository in which to create tasks
	 * @param result
	 *            The list of tasks to be put in the repository
	 * @param monitor
	 *            The progress monitor
	 */
	public void updateTaskRepositoryAsync(TaskRepository repository, List<GerritTask> result, IProgressMonitor monitor) {
		try {
			for (GerritTask gerritTask : result) {

				TaskData taskData = taskDataHandler.createTaskData(repository, gerritTask.getId(), monitor);
