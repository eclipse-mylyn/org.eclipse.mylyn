 ...
 * <ul>
 *   <li>{@link org.eclipse.mylyn.reviews.internal.core.model.Comment#getUser <em>User</em>}</li>
...
public class Comment extends ReviewComponent implements IComment {
	...
	public void setUser(IUser newUser) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReviewsPackage.COMMENT__USER, oldUser, user));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ReviewsPackage.COMMENT__USER:
			return getUser();
		case ReviewsPackage.COMMENT__TYPE:
			return getType();
