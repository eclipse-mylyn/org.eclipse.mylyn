...
public class ConfluenceLanguageTest extends TestCase {
	...
	public void testParagraph() throws Exception {
		...
		assertTrue(Pattern.compile("<body><p>a paragraph</p><p>another paragraph<br/>\\s*with<br/>\\s*2 lines</p></body>",Pattern.MULTILINE).matcher(html).find());
	}
	...
	public void testHeadings() {
		for (int x = 1;x<=6;++x) {
			...
			System.out.println("HTML:"+html);
			assertTrue(Pattern.compile("<body><h"+x+" id=\"aheading\">a heading</h"+x+"><p>with a para</p></body>",Pattern.MULTILINE).matcher(html).find());
	...
	public void testBlockQuote() {
		...
		System.out.println("HTML:"+html);
		assertTrue(Pattern.compile("<body><blockquote><p>a multiline<br/>\\s*block quote</p></blockquote><p>with a para</p></body>",Pattern.MULTILINE).matcher(html).find());
	}
	...
	public void testBlockQuoteExtendedUnclosed() {
		String html = parser.parseToHtml("{quote}\na multiline\nblock quote\n\nwith two paras\n");
		System.out.println("HTML:"+html);
		assertTrue(Pattern.compile("<body><blockquote><p>a multiline<br/>\\s*block quote</p><p>with two paras</p></blockquote></body>",Pattern.MULTILINE).matcher(html).find());
	}
	...
	public void testLineBreak() {
		...
		System.out.println("HTML: \n"+html);
		assertTrue(Pattern.compile("<body><p>a paragraph with an arbitrary<br/>\\s*line break</p></body>",Pattern.MULTILINE).matcher(html).find());
	}
