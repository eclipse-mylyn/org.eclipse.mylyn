...
public class TracWikiLanguageTest extends TestCase {
	...
	public void testParagraphs() throws IOException {
		...
		assertTrue(Pattern.compile("<body><p>first para\\s*new line</p><p>second para</p></body>",Pattern.MULTILINE).matcher(html).find());
	}

	public void testBoldItalic() {
		String html = parser.parseToHtml("normal '''''bold italic text''''' normal");
		System.out.println(html);
		assertTrue(Pattern.compile("<body><p>normal <b><i>bold italic text</i></b> normal</p></body>").matcher(html).find());
	}
	...
	public void testHeadings() {
		for (int x = 1;x<=6;++x) {
			...
			System.out.println(html);
			assertTrue(Pattern.compile("<body><h"+x+">heading text</h"+x+"><p>first para\\s*first para line2</p><p>second para</p><p>third para</p></body>",Pattern.MULTILINE).matcher(html).find());

			html = parser.parseToHtml(delimiter+"heading text"+delimiter+" #with-id-"+x+"\nfirst para\nfirst para line2\n\nsecond para\n\nthird para");
			System.out.println(html);
			assertTrue(Pattern.compile("<body><h"+x+" id=\"with-id-"+x+"\">heading text</h"+x+"><p>first para\\s*first para line2</p><p>second para</p><p>third para</p></body>",Pattern.MULTILINE).matcher(html).find());
		}
	}
	...
	public void testPreformatted() throws IOException {
		...
		System.out.println(html);
		assertTrue(Pattern.compile("<body><p>first para</p><pre>\\s*?\tpreformatted text\\s*spanning multilple lines\\s*</pre><p>second para</p></body>",Pattern.MULTILINE).matcher(html).find());
	}
	...
	public void testQuoteBlock() throws IOException {
		...
		"");
		System.out.println(html);
		assertTrue(Pattern.compile("<body><blockquote><blockquote><p>second level<br/>\\s*second level line 2</p></blockquote><p>first level</p></blockquote><p>new para</p></body>",Pattern.MULTILINE).matcher(html).find());
	}
	...
	public void testQuoteBlockFollowingPara() throws IOException {
		...
		"");
		System.out.println(html);
		assertTrue(Pattern.compile("<body><p>normal para</p><blockquote><p>quoted</p></blockquote><p>new para</p></body>",Pattern.MULTILINE).matcher(html).find());
	}
	...
	public void testQuoteBlockWithSpaces() throws IOException {
		...
		"");
		System.out.println(html);
		assertTrue(Pattern.compile("<body><p>normal para</p><blockquote><p>quoted<br/>\\s*first level</p></blockquote><p>new para</p></body>",Pattern.MULTILINE).matcher(html).find());
	}
	public void testTableBlock() {
		...
		"");
		System.out.println(html);
		assertTrue(Pattern.compile("<body>" +
				"<p>normal para</p>" +
				"<table>" +
				"<tr>" +
				"<td>a table</td>" +
	...
	public void testHyperlink() {
		...
		System.out.println(html);
		assertTrue(Pattern.compile("<body><p>a normal para <a href=\"http://www.example.com\">http://www.example.com</a> with a hyperlink</p></body>",Pattern.MULTILINE).matcher(html).find());
	}
	...
	public void testHyperlinkWithTitle() {
		...
		System.out.println(html);
		assertTrue(Pattern.compile("<body><p>a normal para <a href=\"http://www.example.com\">Example</a> with a hyperlink</p></body>",Pattern.MULTILINE).matcher(html).find());
	}
