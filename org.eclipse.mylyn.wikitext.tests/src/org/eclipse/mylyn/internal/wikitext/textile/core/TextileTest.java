...
public class TextileTest extends TestCase {
	...
	public void testAttributes() {
		...
		String[] values = new String[] {
				...
				"{someStyle}",
				"[someLanguage]",
				"(someClass)(#someId){someStyle}",
				"{someStyle}(someClass)(#someId)"
		};
		String[][] verify = new String[][] {
				{null,"someClass",null,null,null},
				{null,null,"someId",null,null},
				{null,null,null,"someStyle",null},
				{null,null,null,null,"someLanguage"},
