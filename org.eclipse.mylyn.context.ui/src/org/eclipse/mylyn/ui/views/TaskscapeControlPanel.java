 ...
 * @author Mik Kersten
 */
public class TaskscapeControlPanel extends Composite {
    private Scale dosScale;
//    private TableViewer tableViewer; 
    private Scale doiScale;
    
    public TaskscapeControlPanel(ViewPart part, Composite parent, int style) {
        super(parent, style);
...
//        tableViewer.setLabelProvider(new TaskListLabelProvider());
        ...
        doiScale.addSelectionListener(new SelectionListener() {
            public void widgetSelected(SelectionEvent e) {
                TaskscapeManager.getScalingFactors().setInteresting(scaleDoiSelection(doiScale.getSelection()));
                MylarPlugin.getTaskscapeManager().notifyActivePresentationSettingsChange(ITaskscapeListener.UpdateKind.SCALING);
            } 
        ...
        doiScale.addMouseListener(new MouseListener() {
            ...
            public void mouseUp(MouseEvent e) {
                TaskscapeManager.getScalingFactors().setInteresting(scaleDoiSelection(doiScale.getSelection()));
                MylarPlugin.getTaskscapeManager().notifyPostPresentationSettingsChange(ITaskscapeListener.UpdateKind.SCALING);
            }
        });
        ...
        dosScale.addMouseListener(new MouseListener() {
            ...
            public void mouseUp(MouseEvent e) {
                TaskscapeManager.getScalingFactors().setDegreeOfSeparation(
                        dosScale.getSelection());
                MylarPlugin.getTaskscapeManager().refreshRelatedElements();
            }
