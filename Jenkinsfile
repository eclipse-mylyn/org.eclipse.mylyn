	...
	stages {
		...
		stage('Deploy Snapshot') {
			...
			steps {
				...
				'''
				sh '''
					DOWNLOAD_AREA=/home/data/httpd/download.eclipse.org/mylyn/snapshots/nightly/commons/
					echo DOWNLOAD_AREA=$DOWNLOAD_AREA
					ssh genie.mylyn@projects-storage.eclipse.org "\
						rm -rf  ${DOWNLOAD_AREA}/* && \
						mkdir -p ${DOWNLOAD_AREA}"
					scp -r mylyn.commons/org.eclipse.mylyn.commons-site/target/repository/* genie.mylyn@projects-storage.eclipse.org:${DOWNLOAD_AREA}
				'''
				sh '''
					DOWNLOAD_AREA=/home/data/httpd/download.eclipse.org/mylyn/snapshots/nightly/context/
					echo DOWNLOAD_AREA=$DOWNLOAD_AREA
					ssh genie.mylyn@projects-storage.eclipse.org "\
						rm -rf  ${DOWNLOAD_AREA}/* && \
						mkdir -p ${DOWNLOAD_AREA}"
					scp -r mylyn.context/org.eclipse.mylyn.context-site/target/repository/* genie.mylyn@projects-storage.eclipse.org:${DOWNLOAD_AREA}
				'''
				sh '''
				...
				'''
				sh '''
					DOWNLOAD_AREA=/home/data/httpd/download.eclipse.org/mylyn/snapshots/nightly/tasks/
					echo DOWNLOAD_AREA=$DOWNLOAD_AREA
					ssh genie.mylyn@projects-storage.eclipse.org "\
						rm -rf  ${DOWNLOAD_AREA}/* && \
						mkdir -p ${DOWNLOAD_AREA}"
					scp -r mylyn.tasks/org.eclipse.mylyn.tasks-site/target/repository/* genie.mylyn@projects-storage.eclipse.org:${DOWNLOAD_AREA}
				'''
				sh '''
					DOWNLOAD_AREA=/home/data/httpd/download.eclipse.org/mylyn/snapshots/nightly/versions/
					echo DOWNLOAD_AREA=$DOWNLOAD_AREA
					ssh genie.mylyn@projects-storage.eclipse.org "\
						rm -rf  ${DOWNLOAD_AREA}/* && \
						mkdir -p ${DOWNLOAD_AREA}"
					scp -r mylyn.versions/org.eclipse.mylyn.versions-site/target/repository/* genie.mylyn@projects-storage.eclipse.org:${DOWNLOAD_AREA}
				'''
				}
			}
		}
