...
| @javadocBasePackageName@ | Specifies the javadoc base package name to use with "javadoc links":#JavadocLinks.  Defaults to unspecified. |
| @javadocRelativePath@ | Specifies the relative path to related javadoc to use with "javadoc links":#JavadocLinks.  Defaults to unspecified. |
...
This document was written in Textile markup.  The original source code for this document "is available here":http://git.eclipse.org/c/mylyn/org.eclipse.mylyn.docs.git/plain/org.eclipse.mylyn.wikitext.help.ui/help/Mylyn-WikiText-User-Guide.textile
...
h1. Upgrading From Mylyn WikiText 2.x to 3.x
