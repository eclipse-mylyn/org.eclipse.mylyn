...
package org.eclipse.mylyn.wikitext.splitter.tests;
...
public class DefaultSplittingStrategyTest {
	...
	private final class DefaultSplittingStrategyAccess extends DefaultSplittingStrategy {

		@Override
		public String computeSplitTarget() {
			return super.computeSplitTarget();
		}

		@Override
		public String computeSplitTargetCandidate() {
	...
	private final DefaultSplittingStrategyAccess strategy = new DefaultSplittingStrategyAccess();
