...
import org.eclipse.mylar.internal.tasks.ui.ui.ITaskListNotification;
import org.eclipse.mylar.internal.tasks.ui.ui.ITaskListNotificationProvider;
import org.eclipse.mylar.internal.tasks.ui.ui.TaskListColorsAndFonts;
import org.eclipse.mylar.internal.tasks.ui.ui.TaskListNotificationIncoming;
import org.eclipse.mylar.internal.tasks.ui.ui.TaskListNotificationManager;
import org.eclipse.mylar.internal.tasks.ui.ui.TaskListNotificationQueryIncoming;
import org.eclipse.mylar.internal.tasks.ui.ui.TaskListNotificationReminder;
	...
	private static ITaskListNotificationProvider INCOMING_NOTIFICATION_PROVIDER = new ITaskListNotificationProvider() {
		...
		public Set<ITaskListNotification> getNotifications() {
			...
			for (TaskRepository repository : getRepositoryManager().getAllRepositories()) {
				for (AbstractRepositoryTask repositoryTask : TasksUiPlugin.getTaskListManager().getTaskList().getRepositoryTasks(repository.getUrl())) {
...
//			try {
//				File dataDir = new File(ContextCorePlugin.getDefault().getDataDirectory());
