 ...
 * @author Rob Elves
 */
public class TaskListSnapshotManager {

	public static final Pattern SNAPSHOT_REGEXP = Pattern.compile("^mylyndata-.*");
	...
	public TaskListSnapshotManager(String backupFolderPath) {
	...
	private String getBackupFileName() {
		...
		String backupFileName = "mylyndata-" + date + ".zip";
		return backupFileName;
	}

	private void backupNow(boolean synchronous) {
		...
		String fileName = backupFolderPath + File.separator + getBackupFileName();
		...
		if (!synchronous) {
			...
			final TaskDataExportOperation backupJob = new TaskDataExportOperation(destination, true, true, false, false, fileName,
