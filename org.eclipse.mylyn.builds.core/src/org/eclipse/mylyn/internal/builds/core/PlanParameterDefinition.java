 ...
 * </copyright>
 *
 * $Id: PlanParameterDefinition.java,v 1.1 2010/08/27 06:49:23 spingel Exp $
 */
 ...
 * @generated
 */
public class PlanParameterDefinition extends EObjectImpl implements IPlanParameterDefinition {
	/**
	...
	/**
	 * Sets the value of the '{@link org.eclipse.mylyn.internal.builds.core.PlanParameterDefinition#getName
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BuildPackage.PLAN_PARAMETER_DEFINITION__NAME,
					oldName, name));
	}
	...
	/**
	 * Sets the value of the '{@link org.eclipse.mylyn.internal.builds.core.PlanParameterDefinition#getDescription
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BuildPackage.PLAN_PARAMETER_DEFINITION__DESCRIPTION,
	...
	public IBuildPlan getContainingBuildPlan() {
		if (eContainerFeatureID() != BuildPackage.PLAN_PARAMETER_DEFINITION__CONTAINING_BUILD_PLAN)
			return null;
	...
	public NotificationChain basicSetContainingBuildPlan(IBuildPlan newContainingBuildPlan, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainingBuildPlan,
				BuildPackage.PLAN_PARAMETER_DEFINITION__CONTAINING_BUILD_PLAN, msgs);
		return msgs;
	}

	/**
	 * Sets the value of the '
	 * {@link org.eclipse.mylyn.internal.builds.core.PlanParameterDefinition#getContainingBuildPlan
	...
	public void setContainingBuildPlan(IBuildPlan newContainingBuildPlan) {
		if (newContainingBuildPlan != eInternalContainer()
				|| (eContainerFeatureID() != BuildPackage.PLAN_PARAMETER_DEFINITION__CONTAINING_BUILD_PLAN && newContainingBuildPlan != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					BuildPackage.PLAN_PARAMETER_DEFINITION__CONTAINING_BUILD_PLAN, newContainingBuildPlan,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case BuildPackage.PLAN_PARAMETER_DEFINITION__CONTAINING_BUILD_PLAN:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case BuildPackage.PLAN_PARAMETER_DEFINITION__NAME:
			return getName();
		case BuildPackage.PLAN_PARAMETER_DEFINITION__DESCRIPTION:
