 ...
 * </copyright>
 *
 * $Id: BuildState.java,v 1.1 2010/05/28 08:26:25 spingel Exp $
 */
 ...
 * @generated
 */
public enum BuildState implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final BuildState[] VALUES_ARRAY = new BuildState[] { RUNNING, STOPPED, };
	 ...
	 * @generated
	 */
	public static final List<BuildState> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static BuildState get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			BuildState result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static BuildState getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			BuildState result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static BuildState get(int value) {
		switch (value) {
		case RUNNING_VALUE:
			return RUNNING;
		}
	 ...
	 * @generated
	 */
	private BuildState(int value, String name, String literal) {
		this.value = value;
		this.name = name;
