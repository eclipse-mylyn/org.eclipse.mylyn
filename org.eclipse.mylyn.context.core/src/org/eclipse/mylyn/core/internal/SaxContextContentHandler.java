...
//			String id = attributes.getValue(MylarContextExternalizer.ATR_ID);
		...
		case EXPECTING_EVENT:
			try {
				String delta = XmlStringConverter.convertXmlToString(attributes.getValue(MylarContextExternalizer.ATR_DELTA));
				...
				String navigation = XmlStringConverter.convertXmlToString(attributes.getValue(MylarContextExternalizer.ATR_NAVIGATION));
				String originId = XmlStringConverter.convertXmlToString(attributes.getValue(MylarContextExternalizer.ATR_ORIGIN_ID));
				String startDate = attributes.getValue(MylarContextExternalizer.ATR_START_DATE);
				String structureHandle = XmlStringConverter.convertXmlToString(attributes.getValue(MylarContextExternalizer.ATR_STRUCTURE_HANDLE));
				String structureKind = XmlStringConverter.convertXmlToString(attributes.getValue(MylarContextExternalizer.ATR_STRUCTURE_KIND));
