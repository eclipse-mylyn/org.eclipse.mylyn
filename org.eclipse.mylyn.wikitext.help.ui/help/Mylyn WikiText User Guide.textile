...
Wiki markup conversion is performed in Eclipse, see "Conversion In Eclipse":#ConversionInEclipse for more details.
...
# The Ant classpath has changed.  The following jar files will be needed for running Ant tasks:
...
* @org.eclipse.mylyn.wikitext.core.WikiText@ has been moved to @org.eclipse.mylyn.wikitext.core.osgi.WikiText@
