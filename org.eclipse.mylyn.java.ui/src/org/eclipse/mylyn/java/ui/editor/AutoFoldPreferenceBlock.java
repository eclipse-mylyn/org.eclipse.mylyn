...
public class AutoFoldPreferenceBlock
		implements
...
//		addCheckBox(inner,  "collapse.header", "collapse.header", 0); //$NON-NLS-1$
//		addCheckBox(inner,  "collapse.imports", FoldingKeys.COLLAPSE_IMPORTS, 0); //$NON-NLS-1$
//		addCheckBox(inner,  "collapse.inner_type", FoldingKeys.COLLAPSE_INNER_TYPES, 0); //$NON-NLS-1$
//		addCheckBox(inner,  "collapse.static_initializers", FoldingKeys.COLLAPSE_STATICS, 0); //$NON-NLS-1$
//				
//		addCheckBox(inner,  "collapse.comment_blocks", FoldingKeys.COLLAPSE_COMMENT_BLOCKS, 0); //$NON-NLS-1$
//		addCheckBox(inner,  "collapse.javadocs", FoldingKeys.COLLAPSE_JAVADOCS, 0); //$NON-NLS-1$
