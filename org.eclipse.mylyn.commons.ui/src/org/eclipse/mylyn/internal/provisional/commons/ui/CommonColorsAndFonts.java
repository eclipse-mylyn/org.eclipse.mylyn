 ...
 * @author Mik Kersten
 */
public class CommonColorsAndFonts {
	...
	public static boolean isTaskListTheme(String property) {
		if (property == null) {
			...
			return property.equals(CommonColorsAndFonts.THEME_COLOR_TASKLIST_CATEGORY)
					|| property.equals(CommonColorsAndFonts.THEME_COLOR_TASK_PAST_DUE)
					|| property.equals(CommonColorsAndFonts.THEME_COLOR_TASK_PAST_SCHEDULED)
					|| property.equals(CommonColorsAndFonts.THEME_COLOR_TASK_TODAY_COMPLETED)
					|| property.equals(CommonColorsAndFonts.THEME_COLOR_TASK_TODAY_SCHEDULED)
					|| property.equals(CommonColorsAndFonts.THEME_COLOR_TASK_TODAY_SCHEDULED)
					|| property.equals(CommonColorsAndFonts.THEME_COLOR_TASK_THISWEEK_SCHEDULED)
					|| property.equals(CommonColorsAndFonts.THEME_COLOR_TASKS_INCOMING_BACKGROUND)
					|| property.equals(CommonColorsAndFonts.THEME_COLOR_CATEGORY_GRADIENT_START)
					|| property.equals(CommonColorsAndFonts.THEME_COLOR_CATEGORY_GRADIENT_END);
		}
	}
