...
public class HudsonTasksTestAggregatedTestResultAction extends HudsonTasksTestAbstractTestResultAction {
	 ...
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the childReport property.
	 * <p>
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link HudsonTasksTestAggregatedTestResultActionChildReport }
	 */
