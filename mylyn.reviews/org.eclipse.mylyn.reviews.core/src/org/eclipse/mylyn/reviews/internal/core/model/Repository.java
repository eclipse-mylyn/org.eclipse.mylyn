 ...
 * <li>{@link org.eclipse.mylyn.reviews.internal.core.model.Repository#getTaskRepositoryUrl <em>Task Repository Url </em>}</li>
 * <li>{@link org.eclipse.mylyn.reviews.internal.core.model.Repository#getTaskConnectorKind <em>Task Connector Kind </em>}</li>
...
public class Repository extends EObjectImpl implements IRepository {
	...
	public List<IApprovalType> getApprovalTypes() {
		if (approvalTypes == null) {
			approvalTypes = new EObjectContainmentEList.Resolving<>(IApprovalType.class, this,
	...
	public List<IReview> getReviews() {
		if (reviews == null) {
			reviews = new EObjectContainmentWithInverseEList.Resolving<>(IReview.class, this,
	...
	public List<IUser> getUsers() {
		if (users == null) {
			users = new EObjectContainmentEList.Resolving<>(IUser.class, this, ReviewsPackage.REPOSITORY__USERS);
		}
		return users;
	}
