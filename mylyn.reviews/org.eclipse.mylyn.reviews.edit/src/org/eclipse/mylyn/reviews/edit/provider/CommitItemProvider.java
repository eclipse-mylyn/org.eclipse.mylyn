...
/**
 * This is the item provider adapter for a {@link org.eclipse.mylyn.reviews.core.model.ICommit} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class CommitItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	/**
	 * This returns Commit.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Commit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((ICommit) object).getId();
		return label == null || label.length() == 0 ? getString("_UI_Commit_type") : //$NON-NLS-1$
				getString("_UI_Commit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ICommit.class)) {
