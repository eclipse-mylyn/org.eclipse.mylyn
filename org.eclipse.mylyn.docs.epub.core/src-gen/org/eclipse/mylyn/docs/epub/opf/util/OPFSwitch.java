...
public class OPFSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OPFPackage.PACKAGE: {
				org.eclipse.mylyn.docs.epub.opf.Package package_ = (org.eclipse.mylyn.docs.epub.opf.Package)theEObject;
			...
			case OPFPackage.TOURS: {
				Tours tours = (Tours)theEObject;
				T result = caseTours(tours);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T casePackage(org.eclipse.mylyn.docs.epub.opf.Package object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Itemref</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Itemref</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tours</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tours</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTours(Tours object) {
		return null;
	}
