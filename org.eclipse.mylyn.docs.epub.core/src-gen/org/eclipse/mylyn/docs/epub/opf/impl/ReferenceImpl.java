...
public class ReferenceImpl extends EObjectImpl implements Reference {
	...
	protected EClass eStaticClass() {
		return OPFPackage.Literals.REFERENCE;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OPFPackage.REFERENCE__TYPE, oldType, type, !oldTypeESet));
	}
	...
	public void unsetType() {
		...
		typeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OPFPackage.REFERENCE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OPFPackage.REFERENCE__TITLE, oldTitle, title));
	}
	...
	public void setHref(String newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OPFPackage.REFERENCE__HREF, oldHref, href));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OPFPackage.REFERENCE__TITLE:
				return getTitle();
			case OPFPackage.REFERENCE__HREF:
				return getHref();
		}
