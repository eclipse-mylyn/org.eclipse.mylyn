...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Localized DC Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public abstract class LocalizedDCTypeImpl extends DCTypeImpl implements LocalizedDCType {
	...
	public void setLang(String newLang) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DCPackage.LOCALIZED_DC_TYPE__LANG, oldLang, lang));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DCPackage.LOCALIZED_DC_TYPE__LANG:
				return getLang();
		}
