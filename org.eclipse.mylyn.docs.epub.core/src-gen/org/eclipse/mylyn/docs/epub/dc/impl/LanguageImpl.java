 ...
 * @generated
 */
public class LanguageImpl extends DCTypeImpl implements Language {
	/**
	...
	protected EClass eStaticClass() {
		return DCPackage.Literals.LANGUAGE;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DCPackage.LANGUAGE__TYPE, oldType, type));
	}
