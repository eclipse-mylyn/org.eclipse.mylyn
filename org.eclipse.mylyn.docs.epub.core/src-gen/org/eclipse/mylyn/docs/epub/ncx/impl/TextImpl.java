...
public class TextImpl extends EObjectImpl implements Text {
	...
	protected EClass eStaticClass() {
		return NCXPackage.Literals.TEXT;
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, NCXPackage.TEXT__MIXED);
		}
		return mixed;
	}
	...
	public void setClass(Object newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NCXPackage.TEXT__CLASS, oldClass, class_));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NCXPackage.TEXT__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case NCXPackage.TEXT__CLASS:
				return getClass_();
			case NCXPackage.TEXT__ID:
				return getId();
		}
