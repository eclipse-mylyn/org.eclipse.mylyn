...
public class InformationPresenterUtil {
	...
	public static class SizeConstraint {
		 ...
		 * @see InformationPresenter#setSizeConstraints(int, int, boolean, boolean)
		 */
		public SizeConstraint(int horizontalWidthInChars,
				int verticalWidthInChars, boolean enforceAsMinimumSize,
				boolean enforceAsMaximumSize) {
			super();
	 ...
	 * 
	 * @param viewer the viewer for which the information control should be created
	 * @param constraint the size constraint
	 * @param toolBarManager the tool bar manager, or null if there should be none
	 * @param htmlContent the HTML content to be displayed by the information presenter.
	 * 
