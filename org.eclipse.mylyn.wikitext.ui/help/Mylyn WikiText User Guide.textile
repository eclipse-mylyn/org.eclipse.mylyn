...
The appearance of rendered markup in the task editor can be altered in the Eclipse preferences.  Open ==<b>Preferences->General->Editors->Text Editors->WikiText->Appearance</b>== and alter the appearance using CSS styles.
