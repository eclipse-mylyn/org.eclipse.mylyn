...
h2. Editor Markup Appearance

Rendered markup appearance can be altered in the Eclipse preferences.  Open ==<b>Preferences->General->Editors->Text Editors->WikiText->Task Editor Appearance</b>== and alter the appearance using CSS styles.
