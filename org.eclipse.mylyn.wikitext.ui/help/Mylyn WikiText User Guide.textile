...
Default fonts for the task editor when using WikiText can be altered in the Eclipse preferences.  Open ==<b>Preferences->General->Appearance->Colors and Fonts</b>==.  Under ==<b>Tasks</b>== default fonts may be selected:
